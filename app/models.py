...
class Payment(models.Model):
    ...
    player = models.OneToOneField(Player, verbose_name='Player', primary_key=True, on_delete=models.PROTECT, related_name='payment')
...
class WinTotals(models.Model):
    ...
    player = models.OneToOneField(Player, verbose_name='Player', primary_key=True, on_delete=models.PROTECT, related_name='wintotal')
...
class PointsQuerySet(models.QuerySet):
    def weekly_results(self) -> List:
        ...
        return [all_players_points_for_the_week for all_players_points_for_the_week in zip(*temp)]
...
class Points(models.Model):
    ...
    player = models.ForeignKey(Player, verbose_name='Player', on_delete=models.PROTECT, related_name='point')
