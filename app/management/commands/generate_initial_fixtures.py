...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS(
            'Successfully created fixtures file players_fixture.json'))

    def weekly_points(self, player):
        current_event, points_are_final = get_current_event_and_status_from_web()
        # Only consider a week as finished if all points are finalized and
        # league tables have been completely updated
